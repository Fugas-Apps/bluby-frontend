...
const ScannerScreen = () => {
  ...
  const handleAddToMeal = () => {
    Alert.alert('Add to Meal', 'Select a meal to add this item to', [
      { text: 'Breakfast', onPress: () => navigation.navigate('MealDetail', { mealType: 'Breakfast' }) },
      { text: 'Lunch', onPress: () => navigation.navigate('MealDetail', { mealType: 'Lunch' }) },
      { text: 'Dinner', onPress: () => navigation.navigate('MealDetail', { mealType: 'Dinner' }) },
      { text: 'Snacks', onPress: () => navigation.navigate('MealDetail', { mealType: 'Snacks' }) },
  ...
  return (
    <Screen title="Food Scanner" scrollable>
      <View className="mt-4">
        {renderScanArea()}
        ...
        {!scanMode && !hasResult && (
          <Card className="mb-4">
            ...
            <View className="flex-row items-center">
              <Ionicons name="information-circle-outline" size={18} color="#3b82f6" className="mr-2" />
              <Text className="text-gray-600 ml-1">For barcodes, ensure the entire code is visible</Text>
            </View>
          </Card>
        )}
      </View>
