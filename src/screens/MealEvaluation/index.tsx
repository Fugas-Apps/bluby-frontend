...
type MealEvaluationScreenRouteProp = RouteProp<RootStackParamList, 'MealEvaluation'>;
type MealEvaluationScreenNavigationProp = NativeStackNavigationProp<RootStackParamList>;
...
const MealEvaluationScreen = () => {
  const route = useRoute<MealEvaluationScreenRouteProp>();
  const navigation = useNavigation<MealEvaluationScreenNavigationProp>();
  ...
  return (
    <Screen title={`${mealType} Evaluation`} scrollable>
      <View className="mt-4">
...
export default MealEvaluationScreen; 